                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p class="text-gray mb-3"><i class="icofont-list"></i> ORDER
                                                    #25102589748 <i class="icofont-clock-time ml-2"></i> Mon, Nov 12,
                                                    6:26 PM</p>
                                ...
                                <div class="gold-members p-4">
                                    <a href="#">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <span class="float-right text-info">Delivered on Mon, Nov 12, 7:18 PM
                                                ...
                                                <p class="text-gray mb-1"><i class="icofont-location-arrow"></i> 1733
                                    ...
                                    <a href="#">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p class="text-gray mb-1"><i class="icofont-location-arrow"></i> 953 S
                                                    Main St, Centerville, OH 45459, USA
                                                </p>
                                                <p class="text-gray mb-3"><i class="icofont-list"></i> ORDER
                                                    #25102589748 <i class="icofont-clock-time ml-2"></i> Mon, Nov 12,
                                                    6:26 PM</p>
                                                <p class="text-dark">Veg Masala Roll x 5, Veg Penne Pasta in Red Sauce
                                                    x 1
                                                </p>
                                                <hr>
                                                <div class="float-right">
