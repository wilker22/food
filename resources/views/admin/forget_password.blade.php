                                ...
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="index.html" class="d-block auth-logo">
                                        <img src="{{ asset('backend/assets/images/logo-sm.svg') }}" alt=""
                                            height="28"> <span class="logo-txt">WTech</span>
                                    </a>
                                </div>
                                <div class="auth-content my-auto">
                                    <div class="text-center">
                                        <h5 class="mb-0">RESET PASSWORD!</h5>
                                        <p class="text-muted mt-2">Informe seu e-mail para recuperar a senha</p>
                                    </div>
                                    ...
                                    <form class="mt-4 pt-2" method="POST"
                                        ...
                                        <div class="mb-3">
                                            <button class="btn btn-primary w-100 waves-effect waves-light"
                                                type="submit">E-mail Password RESET LINK</button>
                                        </div>
                                    </form>
                                ...
                                <div class="mt-4 mt-md-5 text-center">
                                    <p class="mb-0">©
                                        <script>
                                            ...
                                            class="mdi mdi-heart text-danger"></i> by WTech
                                    </p>
                                </div>
                            </div>
                        </div>
