            ...
            <div class="container">
                <div class="fp__breadcrumb_text">
                    ...
                    <ul>
                        ...
                        <li><a href="#">Criar Nova Senha</a></li>
                    </ul>
                </div>
            </div>
        </div>
                                ...
                                <input type="hidden" name="token" value="{{ $request->route('token') }}">
                                    <div class="col-xl-12">
                                        <div class="fp__login_imput">
                                            <label>email</label>
                                            <input type="email" name="email" value="{{ old('email', $request->email)  }}" placeholder="E-mail">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="fp__login_imput">
                                            ...
                                            <input type="password" name="password_confirmation" placeholder="confrime a Senha">
                                        </div>
                                    </div>
